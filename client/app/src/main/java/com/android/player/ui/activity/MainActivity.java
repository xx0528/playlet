...
import com.android.player.ui.adapter.MainMenuAdapter;
...
import com.android.player.utils.WindowPermission;
import com.android.player.video.ui.activity.PagerListActivity;
                    ...
                    switch (menu.getId()) {
                        ...
                        case 15://画中画
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                ...
                                Toast.makeText(getApplicationContext(),"仅8.0及以上系统支持！",Toast.LENGTH_SHORT).show();
                            }
                            break;
                        case 16://类抖音垂直滚动播放
...
//            mVideoPlayer.startWindow(PlayerUtils.getInstance().dpToPxInt(3f),Color.parseColor("#80000000"),true);
    ...
    public void onDestroy() {
        IWindowManager.getInstance().onReset();
        super.onDestroy();
    }
}