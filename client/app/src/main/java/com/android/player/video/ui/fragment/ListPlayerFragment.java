...
import com.android.player.video.adapter.ListPlayerAdapter;
import com.android.player.video.bean.OpenEyesAuthor;
import com.android.player.video.bean.OpenEyesIndexItemBean;
import com.android.player.video.contract.VideoListContract;
import com.android.player.video.presenter.VideoListPersenter;
import com.android.player.video.ui.widget.PlayerNewbieView;
...
public class ListPlayerFragment extends BaseFragment<VideoListPersenter> implements VideoListContract.View {
    ...
    protected void startPlayer(ViewGroup playerContainer,int position) {
        ...
        IWindowManager.getInstance().quitGlobalWindow();//每次播放清除悬浮窗窗口播放器
